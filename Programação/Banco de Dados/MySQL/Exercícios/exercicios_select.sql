...
-- #7 Qual é a média de pesos dos gafanhotos cadastrados?
SELECT AVG(peso) FROM gafanhotos;

-- #8 Qual é o menor peso entre as gafanhotos mulheres que nasceram no Brasil e entre 01/Jan/1990 e 31/Dez/2000?
SELECT MIN(peso) FROM gafanhotos
WHERE sexo = 'F' AND nacionalidade = 'Brasil' AND nascimento BETWEEN '1990-01-01' AND '2000-12-31';

-- #9 Quantas gafanhotos mulheres têm mais de 1.65 de altura?
